...
const fakeName = () => `${randomItem(firstNames)} ${randomItem(lastNames)}`;
/* ------------------ Phone ------------------ */
const fakePhone = () => `01${randomItem([3, 4, 5, 6, 7, 8, 9])}${randomNumber(10000000, 99999999)}`;
/* ------------------ Address ------------------ */
const cities = [
...
/* ------------------ Multiple Users ------------------ */
const fakeUsers = (count = 10, override = {}) => Array.from({ length: count }, () => fakeUser(override));
